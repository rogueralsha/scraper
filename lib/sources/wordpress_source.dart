...
class WordpressSource extends ASource {
  ...
  WordpressSource() {
    ...
    this.urlScrapers.add(new SimpleUrlScraper(this, siteRegexp,
        [new SimpleUrlScraperCriteria(LinkType.page, "div.gallery a", validateLinkInfo: (LinkInfo li, Element ele) {
  ...
  bool canScrapePage(String url,
    ...
    return metaGenerator?.content?.toLowerCase()?.contains("wordpress")??false;
  }
}
